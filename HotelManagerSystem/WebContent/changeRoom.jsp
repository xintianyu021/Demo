				...
				<div class="container-fluid">
					<div class="row-fluid">
						<div class="control-group">
							...
							<span class="span3">
								当前入住人：<input id="guest" class="vipinput" name="guest" type="text" value="${ order.guest }" readonly style="width:65%"/>
							</span>
							<span class="span3">
								当前身份证号：<input id="idcard" class="vipinput" name="idcard" type="text" value="${ order.idcard }" readonly style="width:65%"/>
							</span>
							<span class="span3">
								当前房间号：<input id="roomid" class="vipinput" name="guest" type="text" value="${ order.roomid }" readonly style="width:65%"/>
							</span>
							<span class="span3">
								当前房间类型：<input id="typename" class="vipinput" name="guest" type="text" value="${ order.roomtype.typename }" readonly style="width:65%"/>
							</span><br>
							<span class="span3">
