	...
	<body>
		...
		<div id="content">
			...
			<div id="breadcrumb">
				...
				<a href="emplist.html">楼层列表</a>
				<a href="#" class="current">新增楼层</a>
			</div>
						...
						<div class="span12">
							<div class="widget-box">
								...
								<div class="widget-content nopadding">
									<form id="eform" action="${ pageContext.request.contextPath }/StoreyServlet?method=getAdd" class="form-horizontal" method="post" />
